...
## Journals
- **T Dang**, L Lapierre, D Crestani. "Reinforcement Learning Algorithms and Applications for Underwater Vehicles: A Survey and A Unified Framework", Preprint, 2026.
- **T Dang**, L Lapierre, D Crestani, P Lambert. "Inverse Dynamics Model Learning and Control for Underwater Robots using Neural Network", Preprint, 2026.
- P Lambert, **T Dang**, L Lapierre, D Crestani. "LZA: A global LocaliZation technique based on Apperance for indoor positioning", Preprint, 2026.
- **T Dang**, L Lapierre, L Daridon. "Energy-Efficient Path Planning for a Hybrid Autonomous Sailboat", Preprint, 2026.
